...
const AnimalModel = () => {
    ...
    return (
        <section className="w-screen h-screen fixed flex justify-center items-center  left-0 top-0 bg-black/50 ">
            <form onSubmit={saveAnimalHandle} className="md:w-[380px] md:min-h-[233px] flex flex-col text-black text-lg leading-3 py-9 px-6 border  rounded-3xl bg-white border-[#141414]">
                <h6>
                    Add Animal
                </h6>
